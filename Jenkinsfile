pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://13.234.204.188:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/PRANEETHKUMAR30918/S111_fullstack_app1.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://13.234.204.188:9090/springapp1"
            echo "✅ Frontend deployed: http://13.234.204.188:9090/frontapp1"
        }
        failure {
